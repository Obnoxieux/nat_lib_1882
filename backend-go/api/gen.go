...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/authors", wrapper.GetAuthors)
	m.HandleFunc("GET "+options.BaseURL+"/authors/{id}", wrapper.GetAuthorById)
	m.HandleFunc("GET "+options.BaseURL+"/authors/{id}/books", wrapper.GetBooksByAuthor)
	m.HandleFunc("GET "+options.BaseURL+"/books", wrapper.GetBooks)
	m.HandleFunc("GET "+options.BaseURL+"/books/{id}", wrapper.GetBookById)
	m.HandleFunc("GET "+options.BaseURL+"/endowments", wrapper.GetEndowments)
	m.HandleFunc("GET "+options.BaseURL+"/endowments/{id}", wrapper.GetEndowmentById)
	m.HandleFunc("GET "+options.BaseURL+"/endowments/{id}/books", wrapper.GetBooksByEndowment)
	m.HandleFunc("GET "+options.BaseURL+"/genres", wrapper.GetGenres)
	m.HandleFunc("GET "+options.BaseURL+"/genres/{id}", wrapper.GetGenreById)
	m.HandleFunc("GET "+options.BaseURL+"/genres/{id}/books", wrapper.GetBooksByGenre)
